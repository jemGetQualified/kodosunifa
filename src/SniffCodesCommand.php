...
class SniffCodesCommand extends Command
{
    ...
    /**
     * List of directory names to not sniff
     *
     * @var array
     */
    protected $invalidDirectories = ['test', 'tests', 'storage', 'build', 'vendor', 'public', 'resources'];
    ...
    /**
     * Gest all directories(only) from the app root
     *
     * @return array
     */
